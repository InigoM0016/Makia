...
public class CreateLead extends PreAndPost{
	...
	public void createLead(String compName,String fName,String lName)  {
		...
		new MyHome(/*driver,test*/).clickLeads().clickCreateLead().typeCompanyName(compName).typeFirstName(fName).typeLastName(lName).clickcreateLead().VerifyFirstName();
	...
	@DataProvider(name="ini")
	private String[][] getdata1() throws IOException {
